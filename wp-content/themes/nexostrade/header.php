            ...
            <div class="nav-wrapper row hide-laptop">
                <div class="nav-elem row">
                    ...
                    <div class="nav-links col">
                        <a class="link-text" href="#">Individual</a>
                        <a class="link-text" href="#">Institutional</a>
                        <a class="link-text" href="#">Personal Plans</a>
                    </div>
                </div>
                <div class="nav-elem row">
                    Trading
                    ...
                    <div class="nav-links col">
                        ...
                        <a class="link-text" href="#">Exchange Listings</a>
                        <a class="link-text" href="#">Margins</a>
                    </div>
                </div>
                <div class="nav-elem row">
                    Invest
                    ...
                    <div class="nav-links col">
                        <a class="link-text" href="#">Assets Managment</a>
                        <a class="link-text" href="#">Savings Plan</a>
                    </div>
                </div>
                <div class="nav-elem row">
                    Platforms
                    ...
                    <div class="nav-links col">
                        <a class="link-text" href="#">All Platform</a>
                    </div>
                </div>
                <div class="nav-elem row">
                    More
                    ...
                    <div class="nav-links col">
                        <a class="link-text" href="#">Education</a>
                        <a class="link-text" href="#">News</a>
                        <a class="link-text" href="#">Support</a>
                    </div>
                </div>
                <div class="nav-elem row">
                    Company
        ...
        <div class="modal col">
            ...
            <div class="nav-wrapper nav-links-wrapper mobile-wrapper col">
                ...
                <div class="nav-elem">
                    ...
                    <div class="nav-links col">
                        <div class="naw-linnks-wrapper">
                            <a class="link-text" href="#">Asset Managment</a>
                            <a class="link-text" href="#">Saving Plan</a>
                        </div>
                    </div>
                </div>
                <div class="nav-elem">
                    ...
                    <div class="nav-links col">
                        <div class="naw-linnks-wrapper">
                            <a class="link-text" href="#">All Platforms</a>
                        </div>
                    </div>
                </div>
                <div class="nav-elem">
